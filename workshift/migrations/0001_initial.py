    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_type', models.CharField(default=b'V', max_length=1, choices=[(b'A', b'Assigned'), (b'B', b'Blown'), (b'I', b'Sign In'), (b'O', b'Sign Out'), (b'V', b'Verify'), (b'S', b'Sell')])),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='person',
            field=models.ForeignKey(blank=True, to='workshift.WorkshiftProfile', help_text=b'Relevant person.', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='regularworkshift',

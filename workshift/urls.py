...
urlpatterns = [
	...
	url(r"^workshift/((P<sem_url>[0-9]+)/)?once/(P<one_off_pk>\d+)/?$", views.one_off_view, name="view_one_off"),
	url(r"^workshift/((P<sem_url>[0-9]+)/)?once/(P<one_off_pk>\d+)/edit/?$", views.edit_one_off_view, name="edit_one_off"),

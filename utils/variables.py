...
{announcement.incumbent}
{announcement.manager}
{announcement.manager.email}

You can view this announcement on the site at {url}.



This message was sent by Farnsworth (https://www.github.com/knagra/farnsworth).
You can manage your e-mail preferences from this page: {profile_url}'''
...
MESSAGES = {
    ...
    'ANNOUNCEMENT_FAIL': u"Farnsworth failed to send your announcement to {failures} of {total} e-mail addresses.",

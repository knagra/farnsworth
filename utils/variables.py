...
SUBTEXTS_404 = (u"The number you have dialed has crashed into a planet.  Please make a note of it.",
	...
	u"Have you ever thought about turning off the TV, sitting down with your children, and hitting them?",
	u"I'm back, baby!",
	u"Let's go, alreadaaaay!",
	u"Yeah, well, I'm gonna go make my own theme park.  With blackjack.  And hookers! In fact, forget the park!",
	u"Fine, I'll go build my own lunar lander.  With blackjack.  And hookers!  In fact, forget the lunar lander and the blackjack!  Eeeh, screw the whole thing!",

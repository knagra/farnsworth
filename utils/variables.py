...
# The e-mail subject used when sending announcement e-mails.
ANNOUNCEMENT_SUBJECT = u"[Farnsworth - {house}] {manager} Announcement"

# The e-mail template used when sending announcement e-mails.
ANNOUNCEMENT_EMAIL = u'''{announcement.body}
<br />
{announcement.incumbent}<br />
{announcement.manager}<br />
<a href="mailto:{announcement.manager.email}">{announcement.manager.email}</a>

<p>You can view this announcement on the site at <a href="{url}">{url}</a>.
You can manage your e-mail preferences from this page: <a href="{profile_url}">{profile_url}</a>.</p>
<br />
<br />
<br />
<p>This message was sent by Farnsworth (<a href="https://www.github.com/knagra/farnsworth">https://www.github.com/knagra/farnsworth</a>).</p>'''
...
SUBTEXTS_404 = (u"The number you have dialed has crashed into a planet.  Please make a note of it.",
    ...
    u"We tore the Internet a new space-hole, all right.  And now it's clenching shut.",
    ...
    u"Presented in double vision (where drunk).",
    u"Based on a true story.",
    u"As foretold by Nostradamus.",
    u"For external use only.",
    u"Not a substitute for human interaction.",
    u"If not entertaining, write your congressman.",
    u"80% entertainment by volume.",
    u"For proper browsing, swallow red pill now.",
    u"Scratch here to reveal prize.",
    u"Fun for the whole family (except grandma and grandpa).",
    u"Or is it?",
    u"Controlling you through a chip in your butt since 2014.",
    u"Too hot for radio.",
    u"Beats a hard kick in the face.",
...
MESSAGES = {
    ...
    'ANONYMOUS_EDIT': u"THIS IS THE ANONYMOUS USER PROFILE.  IT IS HIGHLY RECOMMENDED THAT YOU NOT MODIFY IT. IT SHOULD BE INACTIVE TO PREVENT USERS FROM TRYING TO MANUALLY LOGIN AS THE ANONYMOUS USER.  IT SHOULD BE AN ALUMNUS TO PREVENT CONFUSION IN WORKSHIFT ASSIGNMENT, MANAGER ASSIGNEMENT, ETC.",
    ...
    'RECOUNTED': u"Thread messages and request responses successfully recounted.  {threads_changed} of {thread_count} threads and {requests_changed} of {request_count} requests were out-of-date and updated. {dates_changed} of {thread_count} threads' change dates were out-of-date and updated.",
    ...
    'ANNOUNCEMENT_FAIL': u"Farnsworth failed to e-mail your announcement.",
    'ANNOUNCEMENT_SUCCESS': u"Farnsworth successfully e-mailed your announcement.",
}

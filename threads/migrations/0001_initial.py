...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'threads_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'threads', ['UserProfile'])
        ...
        db.create_table(u'threads_thread', (
            ...
            ('number_of_messages', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'threads', ['Thread'])

        # Adding model 'Message'
        db.create_table(u'threads_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'threads', ['Message'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'threads_userprofile')

        # Deleting model 'Thread'
        db.delete_table(u'threads_thread')

        # Deleting model 'Message'
        db.delete_table(u'threads_message')
    ...
    models = {
        ...
        u'threads.thread': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_of_messages': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['threads.UserProfile']"}),
